...
class PlayerInfoView: UIView {
	...
	@IBOutlet weak var player1PieceStateLbl: UILabel!
	...
	@IBOutlet weak var player2PieceStateLbl: UILabel!
...
//			player1NameLbl.textColor = activeColor
			player1PieceStateLbl.textColor = activeColor
...
//			player2NameLbl.textColor = inActiveColor
			player2PieceStateLbl.textColor = inActiveColor
...
//			player1NameLbl.textColor = inActiveColor
			player1PieceStateLbl.textColor = inActiveColor
...
//			player2NameLbl.textColor = activeColor
			player2PieceStateLbl.textColor = activeColor
